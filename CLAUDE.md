...
- GEMINI.md is a symlink to GEMINI.md
- Daily questions are used to "fill in memory over time" such as: "When did you and your wife meet?" These get stored in the 
